...
def generate_launch_description():
    ...
    declare_gz_gui = DeclareLaunchArgument(
        ...
        default_value=PathJoinSubstitution(
            [FindPackageShare("simulation_team"), "config", "teleop.config"]
        ),
    ...
    declare_components_config_path_arg = DeclareLaunchArgument(
        ...
        default_value=PathJoinSubstitution([
            FindPackageShare("simulation_team"), "config", "components.yaml"
        ]),
    ...
    package_share_directory = FindPackageShare("simulation_team").find("simulation_team")
    ...
    gz_sim = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            PathJoinSubstitution(
                [FindPackageShare("simulation_team"), "launch", "sim_world.launch.py"]
            )
        ),
        launch_arguments={
            "gz_gui": gz_gui,
